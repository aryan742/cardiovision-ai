...
export const SneakyButton = ({ text = "Sneaky", onClick, href = "#", className = "" }: { text?: string, onClick?: () => void, href?: string, className?: string }) => {
  return (
    <a href={href} onClick={onClick} className={`button06 w-inline-block ${className}`}>
